                ...
                child: SingleChildScrollView(
                  child: Column(
                    children: <Widget>[
                      ...
                      Text(ExercisesExpert.excercise[index].name, style: const TextStyle(fontSize: 36), textAlign: TextAlign.center),
                      Container(
                        height: 20,
                        color: Colors.white12,
                      ),
                      Text(ExercisesExpert.excercise[index].description, style: const TextStyle(fontSize: 20)),
                      const SizedBox(height: 20),
                      Text('Lakukan selama ${ExercisesExpert.excercise[index].repetion}.', style: const TextStyle(fontSize: 20)),
                      Row(
