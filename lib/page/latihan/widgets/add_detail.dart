...
class AddDetail extends StatefulWidget {
  ...
  AddDetail({Key? key, required this.detailID, required this.youtubeID, required this.index}) : super(key: key);
...
class _AddDetailState extends State<AddDetail> {
        ...
        child: SingleChildScrollView(
          child: Column(
            children: <Widget>[
              ...
              SizedBox(height: 10),
              Text(excercise.name, style: TextStyle(fontSize: 36), textAlign: TextAlign.center),
              SizedBox(height: 10),
                ...
                children: [
                  ElevatedButton(
                    onPressed: () {
                      ...
                      widget.listController.addExcercise(widget.excerciseDBController.excercise[widget.index]);
                    },
  ...
  Future<readExcercise?> readExcercises() async {
    final docExcercises = FirebaseFirestore.instance.collection("excercise").doc(widget.detailID);
