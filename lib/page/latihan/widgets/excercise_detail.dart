                ...
                child: SingleChildScrollView(
                  child: Column(
                    children: <Widget>[
                      ...
                      Text(widget.excerciseController.excercise2[index].name, style: const TextStyle(fontSize: 36), textAlign: TextAlign.center),
                      Container(
                        height: 20,
                        color: Colors.white12,
                      ),
                      Text(widget.excerciseController.excercise2[index].desc, style: const TextStyle(fontSize: 20)),
                      const SizedBox(height: 20),
                      Text('Lakukan sebanyak ${widget.excerciseController.excercise2[index].rep.toString()} kali', style: const TextStyle(fontSize: 20)),
                      Row(
